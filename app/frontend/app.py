...
class Dashboard:
    ...
    def about(self):
        ...
        st.image("https://raw.githubusercontent.com/tsffarias/LiftOff_Data/refs/heads/main/img/arquitetura_1.1.png", use_column_width=True, caption="Arquitetura do Pipeline de Dados")
